...
python icl.py --dataset fire --src_lang tamil --cross --seed 42 --instruction "Generate a sentiment label for a given input.\nPlease only output the label.." --model_checkpoint sentence-transformers/LaBSE --gen_model_checkpoint bigscience/bloomz-1b7  --cuda --load_in_8bit
...
python icl.py --dataset sib200 --src_lang eng_Latn --cross --seed 42 --instruction "Generate a topic label for a given input.\nPlease only output the label." --model_checkpoint sentence-transformers/LaBSE --gen_model_checkpoint bigscience/bloomz-3b  --cuda --load_in_8bit